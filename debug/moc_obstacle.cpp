...
QT_MOC_LITERAL(1, 9, 14), // "GroundTwinkcle"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 7) // "GetCoin"

    },
    "obstacle\0GroundTwinkcle\0\0GetCoin"
};
...
void obstacle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->GroundTwinkcle(); break;
        case 1: _t->GetCoin(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&obstacle::GroundTwinkcle)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (obstacle::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&obstacle::GetCoin)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject obstacle::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_obstacle.data,
...
void *obstacle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< obstacle*>(this));
...
// SIGNAL 0
void obstacle::GroundTwinkcle()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void obstacle::GetCoin()
{
